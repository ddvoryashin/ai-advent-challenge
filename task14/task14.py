"""
Task 14: INVARIANTS the assistant is not allowed to violate, on top of the
task-lifecycle FSM (task 13) and the personalised three-layer memory (task 12).

What's new compared to task 13
──────────────────────────────
...
def main() -> None:
    ...
    print("          /remember <layer> <text> /task <name> /advance /back /step /expect /note")
